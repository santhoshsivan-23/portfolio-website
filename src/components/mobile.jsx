...
function GlassCard({ children, className = "" }) {
  return (
    <div className={`relative group ${className}`}>
      ...
      ></div>
      <div
        className="relative backdrop-blur-lg border rounded-3xl p-6 glass-hover"
    ...
    >
      ...
      <div className="max-w-xl mx-auto px-5 py-5 relative z-10">
        ...
        >
            ...
            <span className="hover-pop inline-flex items-center gap-2 px-2 py-2 rounded-full text-sm text-white cursor-default" style={{ backgroundColor: "var(--portfolio-badge-bg)" }}>
                <FaRocket />
                Open to Opportunities
            </span>
            <div className="inline-flex items-center gap-2 px-2 py-2 rounded-full text-sm text-white">
            <ThemeDropdown onThemeChange={onThemeChange} /></div>
            </div>

          <h1 className="text-4xl font-extrabold leading-tight" style={{ color: "var(--portfolio-heading)" }}>
            Santhosh
          ...
          <div className="flex flex-col gap-3">
            ...
            <span className="px-4 py-2 rounded-full flex items-center gap-2 text-sm cursor-default" style={{ backgroundColor: "var(--portfolio-pill-bg)" }}>
              <FaEnvelope className="shrink-0" style={{ color: "var(--portfolio-accent)" }} />
              ssivan361@gmail.com
            </span>
            <span className="px-4 py-2 rounded-full flex items-center gap-2 text-sm cursor-default" style={{ backgroundColor: "var(--portfolio-pill-bg)" }}>
              <FaMapMarkerAlt className="shrink-0" style={{ color: "var(--portfolio-accent)" }} />
              Madurai, Tamil Nadu
            </span>
<div className="flex items-center gap-3 flex-nowrap justify-between w-full">
  ...
  >
    ...
    LinkedIn
        ...
        <motion.section
          ...
          className="mt-10"
        >
          <h2 className="text-2xl font-bold flex items-center gap-2 mb-4" style={{ color: "var(--portfolio-heading)" }}>
        ...
        >
          ...
          <GlassCard>
            <div className="space-y-3 text-sm" style={{ color: "var(--portfolio-subtext)" }}>
        ...
        >
          ...
          <GlassCard>
            <h3 className="text-lg font-semibold" style={{ color: "var(--portfolio-heading)" }}>
              Frontend Developer – Warely Software Pvt. Ltd.
            </h3>
            <p className="mt-1 text-sm" style={{ color: "var(--portfolio-accent)" }}>Aug 2025 – Present</p>
            <ul className="list-disc ml-5 mt-4 text-sm space-y-2" style={{ color: "var(--portfolio-subtext)" }}>
      ...
      <ul className="list-disc text-sm ml-6 space-y-3" style={{ color: "var(--portfolio-subtext)" }}>
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <GlassCard>
              <h3 className="text-base font-semibold" style={{ color: "var(--portfolio-heading)" }}>Vibe Chat – MERN + Redux</h3>
              <ul className="list-disc ml-5 mt-3 text-sm space-y-1.5" style={{ color: "var(--portfolio-subtext)" }}>
            ...
            <GlassCard>
              <h3 className="text-base font-semibold" style={{ color: "var(--portfolio-heading)" }}>Online Grocery Management System (PHP + MySQL)</h3>
              <ul className="list-disc ml-5 mt-3 text-sm space-y-1.5" style={{ color: "var(--portfolio-subtext)" }}>
            ...
            <GlassCard>
              <h3 className="text-base font-semibold" style={{ color: "var(--portfolio-heading)" }}>Course Registration Platform (PHP + MySQL)</h3>
              <ul className="list-disc ml-5 mt-3 text-sm space-y-1.5" style={{ color: "var(--portfolio-subtext)" }}>
            ...
            <GlassCard>
              <h3 className="text-base font-semibold" style={{ color: "var(--portfolio-heading)" }}>Mobile Phone Theft Detection App</h3>
              <ul className="list-disc ml-5 mt-3 text-sm space-y-1.5" style={{ color: "var(--portfolio-subtext)" }}>
                <li>GPS tracking</li>
                <li>Photo capture</li>
